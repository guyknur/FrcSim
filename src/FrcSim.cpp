...
void AerialAssist::initialize()
{
    ...
    GFileName AerialAssistField = "res/models/AerialAssistField.gpb";
...
//    FileSystem::createFileFromAsset(AerialAssistField);
//    FileSystem::createFileFromAsset("res/textures/clear.png");
//    FileSystem::createFileFromAsset("res/textures/red.png");
//    FileSystem::createFileFromAsset("res/textures/blue.png");
//    FileSystem::createFileFromAsset("res/textures/white.png");
//    FileSystem::createFileFromAsset("res/textures/tile_floor.png");
//    FileSystem::createFileFromAsset("res/textures/gray.png");
    
    loadTextureMap((const char*)fullPath);
    
#ifdef DEBUG
    fprintf(stderr, "[Debug] Loading model from GPB \"%s\"\n", (const char*)AerialAssistField);
#endif // DEBUG
    
    // load the scene from the gameplay binary file
    Bundle* bundle_ptr = Bundle::create(AerialAssistField);

    // create scene
#ifdef DEBUG
    fprintf(stderr, "[Debug] Creating scene\n");
#endif // DEBUG
    _scene = bundle_ptr->loadScene();
    
    // set ambient light color
#ifdef DEBUG
    fprintf(stderr, "[Debug] Setting ambient color\n");
#endif // DEBUG
    _scene->setAmbientColor(0.15f, 0.15f, 0.15f);
...
//    Material* boxMaterial = boxModel->getMaterial();
    ...
    _camera_h_node->setTranslation(0.0, 500, 275);
    _camera_v_node->setRotation(Vector3(1.0f, 0.0f, 0.0f), MATH_DEG_TO_RAD(-125));
...
void AerialAssist::setMaterial(Node* node_ptr, const char* diffuse_string_ptr, const char* normal_string_ptr, float specularity)
{
    ...
    // create material
    Material* material_ptr = node_ptr->getModel()->setMaterial(VERT_SHADER, FRAG_SHADER, DEF_SHADER);
...
//    material_ptr->getParameter("u_pointLightColor[0]")->bindValue(_light, &Light::getColor);
    ...
    //}
#endif
//    MaterialParameter* parameter = material_ptr->getParameter("u_lightDirection");
//    parameter->bindValue(_light_node, &Node::getForwardVectorView);
}
